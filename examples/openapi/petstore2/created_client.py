...
class pet___petId___uploadImage:
    ...
    class post:
        ...
        class R:
            ...
            # = {'tags': ['pet'], 'operationId': 'uploadFile', 'consumes': ['multipart/form-data'], 'produces': ['application/json'], 'responses': {'200': {'description': 'successful operation', 'schema': Defs.definitions_ApiResponse}}, 'security': [{'petstore_auth': ['write:pets', 'read:pets']}]}
...
class pet:
    ...
    class post:
        ...
        class R:
            _body = ['body'];
            # = {'tags': ['pet'], 'operationId': 'addPet', 'consumes': ['application/json', 'application/xml'], 'produces': ['application/json', 'application/xml'], 'responses': {'405': {'description': 'Invalid input'}}, 'security': [{'petstore_auth': ['write:pets', 'read:pets']}]}
    ...
    class put:
        ...
        class R:
            _body = ['body'];
            # = {'tags': ['pet'], 'operationId': 'updatePet', 'consumes': ['application/json', 'application/xml'], 'produces': ['application/json', 'application/xml'], 'responses': {'400': {'description': 'Invalid ID supplied'}, '404': {'description': 'Pet not found'}, '405': {'description': 'Validation exception'}}, 'security': [{'petstore_auth': ['write:pets', 'read:pets']}]}
            body = Defs.definitions_Pet
        R.body = Defs.definitions_Pet
...
class pet__findByStatus:
    ...
    class get:
        ...
        class R:
            _query = ['status'];
            # = {'tags': ['pet'], 'operationId': 'findPetsByStatus', 'produces': ['application/json', 'application/xml'], 'responses': {'200': {'description': 'successful operation', 'schema': {'type': 'array', 'items': Defs.definitions_Pet}}, '400': {'description': 'Invalid status value'}}, 'security': [{'petstore_auth': ['write:pets', 'read:pets']}]}
...
class pet__findByTags:
    ...
    class get:
        ...
        class R:
            _query = ['tags'];
            # = {'tags': ['pet'], 'operationId': 'findPetsByTags', 'produces': ['application/json', 'application/xml'], 'responses': {'200': {'description': 'successful operation', 'schema': {'type': 'array', 'items': Defs.definitions_Pet}}, '400': {'description': 'Invalid tag value'}}, 'security': [{'petstore_auth': ['write:pets', 'read:pets']}], 'deprecated': True}
...
class pet___petId_:
    ...
    class get:
        ...
        class R:
            _path = ['petId'];
            # = {'tags': ['pet'], 'operationId': 'getPetById', 'produces': ['application/json', 'application/xml'], 'responses': {'200': {'description': 'successful operation', 'schema': Defs.definitions_Pet}, '400': {'description': 'Invalid ID supplied'}, '404': {'description': 'Pet not found'}}, 'security': [{'api_key': []}]}
    ...
    class post:
        ...
        class R:
            ...
            # = {'tags': ['pet'], 'operationId': 'updatePetWithForm', 'consumes': ['application/x-www-form-urlencoded'], 'produces': ['application/json', 'application/xml'], 'responses': {'405': {'description': 'Invalid input'}}, 'security': [{'petstore_auth': ['write:pets', 'read:pets']}]}
    ...
    class delete:
        ...
        class R:
            _path = ['petId'];
            # = {'tags': ['pet'], 'operationId': 'deletePet', 'produces': ['application/json', 'application/xml'], 'responses': {'400': {'description': 'Invalid ID supplied'}, '404': {'description': 'Pet not found'}}, 'security': [{'petstore_auth': ['write:pets', 'read:pets']}]}
...
class store__order:
    ...
    class post:
        ...
        class R:
            _body = ['body'];
            # = {'tags': ['store'], 'operationId': 'placeOrder', 'consumes': ['application/json'], 'produces': ['application/json', 'application/xml'], 'responses': {'200': {'description': 'successful operation', 'schema': Defs.definitions_Order}, '400': {'description': 'Invalid Order'}}}
...
class store__order___orderId_:
    ...
    class get:
        ...
        class R:
            _path = ['orderId'];
            # = {'tags': ['store'], 'operationId': 'getOrderById', 'produces': ['application/json', 'application/xml'], 'responses': {'200': {'description': 'successful operation', 'schema': Defs.definitions_Order}, '400': {'description': 'Invalid ID supplied'}, '404': {'description': 'Order not found'}}}
    ...
    class delete:
        ...
        class R:
            _path = ['orderId'];
            # = {'tags': ['store'], 'operationId': 'deleteOrder', 'produces': ['application/json', 'application/xml'], 'responses': {'400': {'description': 'Invalid ID supplied'}, '404': {'description': 'Order not found'}}}
...
class store__inventory:
    ...
    class get:
        ...
        class R:
            # = {'tags': ['store'], 'operationId': 'getInventory', 'produces': ['application/json'], 'responses': {'200': {'description': 'successful operation', 'schema': {'type': 'object', 'additionalProperties': {'type': 'integer', 'format': 'int32'}}}}, 'security': [{'api_key': []}]}
            pass
...
class user__createWithArray:
    ...
    class post:
        ...
        class R:
            _body = ['body'];
            # = {'tags': ['user'], 'operationId': 'createUsersWithArrayInput', 'consumes': ['application/json'], 'produces': ['application/json', 'application/xml'], 'responses': {'default': {'description': 'successful operation'}}}
...
class user__createWithList:
    ...
    class post:
        ...
        class R:
            _body = ['body'];
            # = {'tags': ['user'], 'operationId': 'createUsersWithListInput', 'consumes': ['application/json'], 'produces': ['application/json', 'application/xml'], 'responses': {'default': {'description': 'successful operation'}}}
            body = {'type': 'array', 'items': Defs.definitions_User}
        R.body = [Defs.definitions_User]
...
class user___username_:
    ...
    class get:
        ...
        class R:
            _path = ['username'];
            # = {'tags': ['user'], 'operationId': 'getUserByName', 'produces': ['application/json', 'application/xml'], 'responses': {'200': {'description': 'successful operation', 'schema': Defs.definitions_User}, '400': {'description': 'Invalid username supplied'}, '404': {'description': 'User not found'}}}
    ...
    class put:
        ...
        class R:
            ...
            # = {'tags': ['user'], 'operationId': 'updateUser', 'consumes': ['application/json'], 'produces': ['application/json', 'application/xml'], 'responses': {'400': {'description': 'Invalid user supplied'}, '404': {'description': 'User not found'}}}
    ...
    class delete:
        ...
        class R:
            _path = ['username'];
            # = {'tags': ['user'], 'operationId': 'deleteUser', 'produces': ['application/json', 'application/xml'], 'responses': {'400': {'description': 'Invalid username supplied'}, '404': {'description': 'User not found'}}}
...
class user__logout:
    ...
    class get:
        ...
        class R:
            # = {'tags': ['user'], 'operationId': 'logoutUser', 'produces': ['application/json', 'application/xml'], 'responses': {'default': {'description': 'successful operation'}}}
            pass
...
class user:
    ...
    class post:
        ...
        class R:
            _body = ['body'];
            # = {'tags': ['user'], 'operationId': 'createUser', 'consumes': ['application/json'], 'produces': ['application/json', 'application/xml'], 'responses': {'default': {'description': 'successful operation'}}}
            body = Defs.definitions_User
        R.body = Defs.definitions_User
...
keyw = {'async', 'for', 'not', 'import', 'if', 'from', 'raise', 'while', 'except', 'continue'}
