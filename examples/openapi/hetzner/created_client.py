...
class actions:
    ...
    class get:
        ...
        class R:
            ...
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_list_actions_response}}, 'description': 'The `actions` key contains a list of Actions'}}, 'tags': ['actions'], 'operationId': 'list_actions'}
            id = {'type': 'integer'}
...
class actions___id_:
    ...
    class get:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_get_action_response}}, 'description': 'The `action` key in the reply has this structure'}}, 'tags': ['actions'], 'operationId': 'get_action'}
            id = {'type': 'integer'}
        R.id = id
...
class certificates___id_:
    ...
    class delete:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'204': {'description': 'Certificate deleted'}}, 'tags': ['certificates'], 'operationId': 'delete_certificate'}
            id = {'type': 'integer'}
        R.id = id
...
| `dns_zone_is_secondary_zone`                            | DNS zone is a secondary zone                                              |
 Retry Issuance or Renewal"""
        class R:
            _path = ['id'];
            # = {'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'issue_certificate', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': '2021-01-30T23:57:00+00:00', 'id': 14, 'progress': 100, 'resources': [{'id': 896, 'type': 'certificate'}], 'started': '2021-01-30T23:55:00+00:00', 'status': 'success'}}, 'schema': Defs.components_schemas_retry_issuance_or_renewal_response}}, 'description': 'The `action` key contains the resulting Action'}}, 'tags': ['certificates'], 'operationId': 'retry_issuance_or_renewal'}
            id = {'type': 'integer'}
        R.id = id
...
class datacenters:
    ...
    class get:
        ...
        class R:
            _query = ['name'];
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_list_datacenters_response}}, 'description': 'The reply contains the `datacenters` and `recommendation` keys'}}, 'tags': ['datacenters'], 'operationId': 'list_datacenters'}
            name = {'type': 'string'}
        R.name = str_dflt
...
class datacenters___id_:
    ...
    class get:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_get_datacenter_response}}, 'description': 'The `datacenter` key in the reply contains a Datacenter object with this structure'}}, 'tags': ['datacenters'], 'operationId': 'get_datacenter'}
            id = {'type': 'integer'}
        R.id = id
...
class firewalls:
    ...
    class get:
        ...
        class R:
            ...
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_list_firewalls_response}}, 'description': 'The `firewalls` key contains an array of Firewall objects'}}, 'tags': ['firewalls'], 'operationId': 'list_firewalls'}
            sort = {'enum': ['id', 'id:asc', 'id:desc', 'name', 'name:asc', 'name:desc', 'created', 'created:asc', 'created:desc'], 'type': 'string'}
            name = {'type': 'string'}
            label_selector = {'type': 'string'}
            page = {'type': 'integer', 'minimum': 1}
...
| `firewall_resource_not_found` | The resource the Firewall should be attached to was not found |
 Create a Firewall"""
        class R:
            _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'schema': Defs.components_schemas_create_firewall_response}}, 'description': 'The `firewall` key contains the Firewall that was just created'}}, 'tags': ['firewalls'], 'operationId': 'create_firewall', 'mime': 'application/json'}
...
| `resource_in_use`    | Firewall must not be in use to be deleted |
 Delete a Firewall"""
        class R:
            _path = ['id'];
            # = {'responses': {'204': {'description': 'Firewall deleted'}}, 'tags': ['firewalls'], 'operationId': 'delete_firewall'}
            id = {'type': 'integer'}
        R.id = id
    ...
    class get:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_get_firewall_response}}, 'description': 'The `firewall` key contains a Firewall object'}}, 'tags': ['firewalls'], 'operationId': 'get_firewall'}
            id = {'type': 'integer'}
        R.id = id
...
Note: if the Firewall object changes during the request, the response will be a “conflict” error.
 Update a Firewall"""
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_replace_firewall_response}}, 'description': 'The `firewall` key contains the Firewall that was just updated'}}, 'tags': ['firewalls'], 'operationId': 'replace_firewall', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
| `firewall_resource_not_found` | The resource the Firewall should be attached to was not found |
 Apply to Resources"""
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'actions': [{'command': 'apply_firewall', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': '2016-01-30T23:56:00+00:00', 'id': 14, 'progress': 100, 'resources': [{'id': 42, 'type': 'server'}, {'id': 38, 'type': 'firewall'}], 'started': '2016-01-30T23:55:00+00:00', 'status': 'success'}]}, 'schema': Defs.components_schemas_apply_to_resources_response}}, 'description': 'The `actions` key contains multiple `apply_firewall` Actions'}}, 'tags': ['firewalls'], 'operationId': 'apply_to_resources', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
| `firewall_managed_by_label_selector`  | Firewall was applied via label selector and cannot be removed manually |
 Remove from Resources"""
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'actions': [{'command': 'remove_firewall', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': '2016-01-30T23:56:00+00:00', 'id': 14, 'progress': 100, 'resources': [{'id': 42, 'type': 'server'}, {'id': 38, 'type': 'firewall'}], 'started': '2016-01-30T23:55:00+00:00', 'status': 'success'}]}, 'schema': Defs.components_schemas_remove_from_resources_response}}, 'description': 'The `actions` key contains multiple `remove_firewall` Actions'}}, 'tags': ['firewalls'], 'operationId': 'remove_from_resources', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
| `firewall_resource_not_found` | The resource the Firewall should be attached to was not found |
 Set Rules"""
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'actions': [{'command': 'set_firewall_rules', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': '2016-01-30T23:56:00+00:00', 'id': 13, 'progress': 100, 'resources': [{'id': 38, 'type': 'firewall'}], 'started': '2016-01-30T23:55:00+00:00', 'status': 'success'}, {'command': 'apply_firewall', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': '2016-01-30T23:56:00+00:00', 'id': 14, 'progress': 100, 'resources': [{'id': 38, 'type': 'firewall'}, {'id': 42, 'type': 'server'}], 'started': '2016-01-30T23:55:00+00:00', 'status': 'success'}]}, 'schema': Defs.components_schemas_set_rules_response}}, 'description': 'The `action` key contains one `set_firewall_rules` Action plus one `apply_firewall` Action per resource where the Firewall is active'}}, 'tags': ['firewalls'], 'operationId': 'set_rules', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
class floating_ips:
    ...
    class get:
        ...
        class R:
            ...
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_list_floating_ips_response}}, 'description': 'The `floating_ips` key in the reply contains an array of Floating IP objects with this structure'}}, 'tags': ['floating_ips'], 'operationId': 'list_floating_ips'}
            name = {'type': 'string'}
            label_selector = {'type': 'string'}
...
class floating_ips___id_:
    ...
    class delete:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'204': {'description': 'Floating IP deleted'}}, 'tags': ['floating_ips'], 'operationId': 'delete_floating_ip'}
            id = {'type': 'integer'}
        R.id = id
    ...
    class get:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_get_floating_ip_response}}, 'description': 'The `floating_ip` key in the reply contains a Floating IP object with this structure'}}, 'tags': ['floating_ips'], 'operationId': 'get_floating_ip'}
            id = {'type': 'integer'}
        R.id = id
...
class floating_ips___id___actions__assign:
    ...
    class post:
        ...
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'assign_floating_ip', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': '2016-01-30T23:56:00+00:00', 'id': 13, 'progress': 100, 'resources': [{'id': 42, 'type': 'server'}, {'id': 4711, 'type': 'floating_ip'}], 'started': '2016-01-30T23:55:00+00:00', 'status': 'success'}}, 'schema': Defs.components_schemas_assign_floating_ip_to_server_response}}, 'description': 'The `action` key contains the `assign` Action'}}, 'tags': ['floating_ips'], 'operationId': 'assign_floating_ip_to_server', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
class floating_ips___id___actions__change_protection:
    ...
    class post:
        ...
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'change_protection', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': '2016-01-30T23:56:00+00:00', 'id': 13, 'progress': 100, 'resources': [{'id': 4711, 'type': 'floating_ip'}], 'started': '2016-01-30T23:55:00+00:00', 'status': 'success'}}, 'schema': Defs.components_schemas_change_floating_ip_protection_response}}, 'description': 'The `action` key contains the `change_protection` Action'}}, 'tags': ['floating_ips'], 'operationId': 'change_floating_ip_protection', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
class floating_ips___id___actions__unassign:
    ...
    class post:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'unassign_floating_ip', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': '2016-01-30T23:56:00+00:00', 'id': 13, 'progress': 100, 'resources': [{'id': 42, 'type': 'server'}, {'id': 4711, 'type': 'floating_ip'}], 'started': '2016-01-30T23:55:00+00:00', 'status': 'success'}}, 'schema': Defs.components_schemas_unassign_floating_ip_response}}, 'description': 'The `action` key contains the `unassign` Action'}}, 'tags': ['floating_ips'], 'operationId': 'unassign_floating_ip'}
            id = {'type': 'integer'}
        R.id = id
...
class images:
    ...
    class get:
        ...
        class R:
            ...
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_list_images_response}}, 'description': 'The `images` key in the reply contains an array of Image objects with this structure'}}, 'tags': ['images'], 'operationId': 'list_images'}
            sort = {'enum': ['id', 'id:asc', 'id:desc', 'name', 'name:asc', 'name:desc', 'created', 'created:asc', 'created:desc'], 'type': 'string'}
...
class images___id_:
    ...
    class delete:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'204': {'description': 'Image deleted'}}, 'tags': ['images'], 'operationId': 'delete_image'}
            id = {'type': 'integer'}
        R.id = id
    ...
    class get:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_get_image_response}}, 'description': 'The `image` key in the reply contains an Image object with this structure'}}, 'tags': ['images'], 'operationId': 'get_image'}
            id = {'type': 'integer'}
        R.id = id
...
class images___id___actions__change_protection:
    ...
    class post:
        ...
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'change_protection', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': '2016-01-30T23:56:00+00:00', 'id': 13, 'progress': 100, 'resources': [{'id': 4711, 'type': 'image'}], 'started': '2016-01-30T23:55:00+00:00', 'status': 'success'}}, 'schema': Defs.components_schemas_change_image_protection_response}}, 'description': 'The `action` key contains the `change_protection` Action'}}, 'tags': ['images'], 'operationId': 'change_image_protection', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
class isos:
    ...
    class get:
        ...
        class R:
            ...
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_list_isos_response}}, 'description': 'The `isos` key in the reply contains an array of iso objects with this structure'}}, 'tags': ['isos'], 'operationId': 'list_isos'}
            name = {'type': 'string'}
            page = {'type': 'integer', 'minimum': 1}
            per_page = {'type': 'integer', 'minimum': 1, 'maximum': 50}
        R.name = str_dflt
...
class isos___id_:
    ...
    class get:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_get_iso_response}}, 'description': 'The `iso` key in the reply contains an array of ISO objects with this structure'}}, 'tags': ['isos'], 'operationId': 'get_iso'}
            id = {'type': 'integer'}
        R.id = id
...
class load_balancer_types:
    ...
    class get:
        ...
        class R:
            _query = ['name', 'page', 'per_page'];
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_list_load_balancer_types_response}}, 'description': 'The `load_balancer_types` key in the reply contains an array of Load Balancer type objects with this structure'}}, 'tags': ['load_balancer_types'], 'operationId': 'list_load_balancer_types'}
            name = {'type': 'string'}
            page = {'type': 'integer', 'minimum': 1}
            per_page = {'type': 'integer', 'minimum': 1, 'maximum': 50}
        R.name = str_dflt
...
class load_balancer_types___id_:
    ...
    class get:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_get_load_balancer_type_response}}, 'description': 'The `load_balancer_type` key in the reply contains a Load Balancer type object with this structure'}}, 'tags': ['load_balancer_types'], 'operationId': 'get_load_balancer_type'}
            id = {'type': 'integer'}
        R.id = id
...
class load_balancers:
    ...
    class get:
        ...
        class R:
            _query = ['sort', 'name', 'label_selector', 'page', 'per_page'];
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_list_load_balancers_response}}, 'description': 'The `load_balancers` key contains a list of Load Balancers'}}, 'tags': ['load_balancers'], 'operationId': 'list_load_balancers'}
            sort = {'enum': ['id', 'id:asc', 'id:desc', 'name', 'name:asc', 'name:desc', 'created', 'created:asc', 'created:desc'], 'type': 'string'}
            name = {'type': 'string'}
            label_selector = {'type': 'string'}
            page = {'type': 'integer', 'minimum': 1}
...
class load_balancers___id_:
    ...
    class delete:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'204': {'description': 'Load Balancer deleted'}}, 'tags': ['load_balancers'], 'operationId': 'delete_load_balancer'}
            id = {'type': 'integer'}
        R.id = id
    ...
    class get:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_get_load_balancer_response}}, 'description': 'The `load_balancer` key contains the Load Balancer'}}, 'tags': ['load_balancers'], 'operationId': 'get_load_balancer'}
            id = {'type': 'integer'}
        R.id = id
...
| `source_port_already_used` | The source port you are trying to add is already in use |
 Add Service"""
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'add_service', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': '2016-01-30T23:56:00+00:00', 'id': 13, 'progress': 100, 'resources': [{'id': 4711, 'type': 'load_balancer'}], 'started': '2016-01-30T23:55:00+00:00', 'status': 'success'}}, 'schema': Defs.components_schemas_add_service_response}}, 'description': 'The `action` key contains the `add_service` Action'}}, 'tags': ['load_balancers'], 'operationId': 'add_service', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
| `target_already_defined`                | The Load Balancer target you are trying to define is already defined                                  |
 Add Target"""
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'add_target', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': '2016-01-30T23:56:00+00:00', 'id': 13, 'progress': 100, 'resources': [{'id': 4711, 'type': 'load_balancer'}], 'started': '2016-01-30T23:55:00+00:00', 'status': 'success'}}, 'schema': Defs.components_schemas_add_target_response}}, 'description': 'The `action` key contains the `add_target` Action'}}, 'tags': ['load_balancers'], 'operationId': 'add_target', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
| `no_subnet_available`            | No Subnet or IP is available for the Load Balancer within the network |
 Attach a Load Balancer to a Network"""
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'attach_to_network', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': '2016-01-30T23:56:00+00:00', 'id': 13, 'progress': 100, 'resources': [{'id': 4711, 'type': 'load_balancer'}], 'started': '2016-01-30T23:55:00+00:00', 'status': 'success'}}, 'schema': Defs.components_schemas_attach_load_balancer_to_network_response}}, 'description': 'The `action` key contains the `attach_to_network` Action'}}, 'tags': ['load_balancers'], 'operationId': 'attach_load_balancer_to_network', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
class load_balancers___id___actions__change_algorithm:
    ...
    class post:
        ...
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'change_algorithm', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': '2016-01-30T23:56:00+00:00', 'id': 13, 'progress': 100, 'resources': [{'id': 4711, 'type': 'load_balancer'}], 'started': '2016-01-30T23:55:00+00:00', 'status': 'success'}}, 'schema': Defs.components_schemas_change_algorithm_response}}, 'description': 'The `action` key contains the `change_algorithm` Action'}}, 'tags': ['load_balancers'], 'operationId': 'change_algorithm', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
class load_balancers___id___actions__change_protection:
    ...
    class post:
        ...
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'change_protection', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': '2016-01-30T23:56:00+00:00', 'id': 13, 'progress': 100, 'resources': [{'id': 4711, 'type': 'load_balancer'}], 'started': '2016-01-30T23:55:00+00:00', 'status': 'success'}}, 'schema': Defs.components_schemas_change_load_balancer_protection_response}}, 'description': 'The `action` key contains the `change_protection` Action'}}, 'tags': ['load_balancers'], 'operationId': 'change_load_balancer_protection', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
class load_balancers___id___actions__delete_service:
    ...
    class post:
        ...
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'delete_service', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': '2016-01-30T23:56:00+00:00', 'id': 13, 'progress': 100, 'resources': [{'id': 4711, 'type': 'load_balancer'}], 'started': '2016-01-30T23:55:00+00:00', 'status': 'success'}}, 'schema': Defs.components_schemas_delete_service_response}}, 'description': 'The `action` key contains the `delete_service` Action'}}, 'tags': ['load_balancers'], 'operationId': 'delete_service', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
class load_balancers___id___actions__detach_from_network:
    ...
    class post:
        ...
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'detach_from_network', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': None, 'id': 13, 'progress': 0, 'resources': [{'id': 42, 'type': 'server'}, {'id': 4711, 'type': 'network'}], 'started': '2016-01-30T23:50:00+00:00', 'status': 'running'}}, 'schema': Defs.components_schemas_detach_load_balancer_from_network_response}}, 'description': 'The `action` key contains the `detach_from_network` Action'}}, 'tags': ['load_balancers'], 'operationId': 'detach_load_balancer_from_network', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
| `targets_without_use_private_ip`          | The Load Balancer has targets that use the public IP instead of the private IP |
 Disable the public interface of a Load Balancer"""
        class R:
            _path = ['id'];
            # = {'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'disable_public_interface', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': None, 'id': 13, 'progress': 0, 'resources': [{'id': 42, 'type': 'server'}, {'id': 4711, 'type': 'network'}], 'started': '2016-01-30T23:50:00+00:00', 'status': 'running'}}, 'schema': Defs.components_schemas_disable_public_interface_of_load_balancer_response}}, 'description': 'The `action` key contains the `disable_public_interface` Action'}}, 'tags': ['load_balancers'], 'operationId': 'disable_public_interface_of_load_balancer'}
            id = {'type': 'integer'}
        R.id = id
...
class load_balancers___id___actions__enable_public_interface:
    ...
    class post:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'enable_public_interface', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': None, 'id': 13, 'progress': 0, 'resources': [{'id': 42, 'type': 'server'}, {'id': 4711, 'type': 'network'}], 'started': '2016-01-30T23:50:00+00:00', 'status': 'running'}}, 'schema': Defs.components_schemas_enable_public_interface_of_load_balancer_response}}, 'description': 'The `action` key contains the `enable_public_interface` Action'}}, 'tags': ['load_balancers'], 'operationId': 'enable_public_interface_of_load_balancer'}
            id = {'type': 'integer'}
        R.id = id
...
class load_balancers___id___actions__remove_target:
    ...
    class post:
        ...
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'remove_target', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': '2016-01-30T23:56:00+00:00', 'id': 13, 'progress': 100, 'resources': [{'id': 4711, 'type': 'load_balancer'}], 'started': '2016-01-30T23:55:00+00:00', 'status': 'success'}}, 'schema': Defs.components_schemas_remove_target_response}}, 'description': 'The `action` key contains the `remove_target` Action'}}, 'tags': ['load_balancers'], 'operationId': 'remove_target', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
| `source_port_already_used` | The source port you are trying to add is already in use |
 Update Service"""
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'update_service', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': '2016-01-30T23:56:00+00:00', 'id': 13, 'progress': 100, 'resources': [{'id': 4711, 'type': 'load_balancer'}], 'started': '2016-01-30T23:55:00+00:00', 'status': 'success'}}, 'schema': Defs.components_schemas_update_service_response}}, 'description': 'The `action` key contains the `update_service` Action'}}, 'tags': ['load_balancers'], 'operationId': 'update_service', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
We limit the number of samples to a maximum of 500 and will adjust the step parameter accordingly.
 Get Metrics for a LoadBalancer"""
        class R:
            ...
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_get_metrics_for_loadbalancer_response}}, 'description': 'The `metrics` key in the reply contains a metrics object with this structure'}}, 'tags': ['load_balancers'], 'operationId': 'get_metrics_for_loadbalancer'}
            id = {'type': 'integer'}
...
class locations:
    ...
    class get:
        ...
        class R:
            _query = ['name', 'page', 'per_page'];
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_list_locations_response}}, 'description': 'The `locations` key in the reply contains an array of Location objects with this structure'}}, 'tags': ['locations'], 'operationId': 'list_locations'}
            name = {'type': 'string'}
            page = {'type': 'integer', 'minimum': 1}
            per_page = {'type': 'integer', 'minimum': 1, 'maximum': 50}
        R.name = str_dflt
...
class locations___id_:
    ...
    class get:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_get_location_response}}, 'description': 'The `location` key in the reply contains a Location object with this structure'}}, 'tags': ['locations'], 'operationId': 'get_location'}
            id = {'type': 'integer'}
        R.id = id
...
class networks:
    ...
    class get:
        ...
        class R:
            ...
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_list_networks_response}}, 'description': 'The `networks` key contains a list of networks'}}, 'tags': ['networks'], 'operationId': 'list_networks'}
            name = {'type': 'string'}
            label_selector = {'type': 'string'}
            page = {'type': 'integer', 'minimum': 1}
            per_page = {'type': 'integer', 'minimum': 1, 'maximum': 50}
...
You may specify one or more routes in `routes`. You can also add more routes later by using the [add route action](https://docs.hetzner.cloud/#network-actions-add-a-route-to-a-network).
 Create a Network"""
        class R:
            _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'schema': Defs.components_schemas_create_network_response}}, 'description': 'The `network` key contains the network that was just created'}}, 'tags': ['networks'], 'operationId': 'create_network', 'mime': 'application/json'}
...
Note: if the network object changes during the request, the response will be a “conflict” error.
 Delete a Network"""
        class R:
            _path = ['id'];
            # = {'responses': {'204': {'description': 'Network deleted'}}, 'tags': ['networks'], 'operationId': 'delete_network'}
            id = {'type': 'integer'}
        R.id = id
    ...
    class get:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_get_network_response}}, 'description': 'The `network` key contains the network'}}, 'tags': ['networks'], 'operationId': 'get_network'}
            id = {'type': 'integer'}
        R.id = id
...
Note: if the Network object changes during the request, the response will be a “conflict” error.
 Change IP range of a Network"""
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'change_ip_range', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': '2016-01-30T23:56:00+00:00', 'id': 13, 'progress': 100, 'resources': [{'id': 4711, 'type': 'network'}], 'started': '2016-01-30T23:55:00+00:00', 'status': 'success'}}, 'schema': Defs.components_schemas_change_ip_range_of_network_response}}, 'description': 'The `action` key contains the `change_ip_range` Action'}}, 'tags': ['networks'], 'operationId': 'change_ip_range_of_network', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
Note: if the Network object changes during the request, the response will be a “conflict” error.
 Change Network Protection"""
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'change_protection', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': '2016-01-30T23:56:00+00:00', 'id': 13, 'progress': 100, 'resources': [{'id': 4711, 'type': 'network'}], 'started': '2016-01-30T23:55:00+00:00', 'status': 'success'}}, 'schema': Defs.components_schemas_change_network_protection_response}}, 'description': 'The `action` key contains the `change_protection` Action'}}, 'tags': ['networks'], 'operationId': 'change_network_protection', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
Note: if the Network object changes during the request, the response will be a “conflict” error.
 Delete a subnet from a Network"""
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'delete_subnet', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': None, 'id': 13, 'progress': 0, 'resources': [{'id': 4711, 'type': 'network'}], 'started': '2016-01-30T23:50:00+00:00', 'status': 'running'}}, 'schema': Defs.components_schemas_delete_subnet_from_network_response}}, 'description': 'The `action` key contains the `delete_subnet` Action'}}, 'tags': ['networks'], 'operationId': 'delete_subnet_from_network', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
class placement_groups___id_:
    ...
    class delete:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'204': {'description': 'PlacementGroup deleted'}}, 'tags': ['placement_groups'], 'operationId': 'delete_placementgroup'}
            id = {'type': 'integer'}
        R.id = id
...
Both net and gross prices are included in the response.
 Get all prices"""
        class R:
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_list_prices_response}}, 'description': 'The `pricing` key in the reply contains an pricing object with this structure'}}, 'tags': ['pricing'], 'operationId': 'list_prices'}
            pass
...
class primary_ips:
    ...
    class get:
        ...
        class R:
            ...
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_list_primary_ips_response}}, 'description': 'The `primary_ips` key contains an array of Primary IP objects'}}, 'tags': ['primary_ips'], 'operationId': 'list_primary_ips'}
            name = {'type': 'string'}
            label_selector = {'type': 'string'}
            ip = {'type': 'string'}
            sort = {'enum': ['id', 'id:asc', 'id:desc', 'created', 'created:asc', 'created:desc'], 'type': 'string'}
...
The Primary IP may be assigned to a Server. In this case it is unassigned automatically. The Server must be powered off (status `off`) in order for this operation to succeed.
 Delete a Primary IP"""
        class R:
            _path = ['id'];
            # = {'responses': {'204': {'description': 'Primary IP deleted'}}, 'tags': ['primary_ips'], 'operationId': 'delete_primary_ip'}
            id = {'type': 'integer'}
        R.id = id
    ...
    class get:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_get_primary_ip_response}}, 'description': 'The `primary_ip` key contains a Primary IP object'}}, 'tags': ['primary_ips'], 'operationId': 'get_primary_ip'}
            id = {'type': 'integer'}
        R.id = id
...
If the Primary IP object changes during the request, the response will be a “conflict” error.
 Update a Primary IP"""
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_replace_primary_ip_response}}, 'description': 'The `primary_ip` key contains the Primary IP that was just updated'}}, 'tags': ['primary_ips'], 'operationId': 'replace_primary_ip', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
| `server_has_ipv6`             | The server already has an ipv6 address                        |
 Assign a Primary IP to a resource"""
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'assign_primary_ip', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': None, 'id': 13, 'progress': 0, 'resources': [{'id': 42, 'type': 'server'}, {'id': 4711, 'type': 'primary_ip'}], 'started': '2016-01-30T23:50:00+00:00', 'status': 'running'}}, 'schema': Defs.components_schemas_assign_primary_ip_to_resource_response}}, 'description': 'The `action` key in the reply contains an Action object with this structure'}}, 'tags': ['primary_ips'], 'operationId': 'assign_primary_ip_to_resource', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
A Primary IP can only be delete protected if its `auto_delete` property is set to `false`.
 Change Primary IP Protection"""
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'change_protection', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': '2016-01-30T23:56:00+00:00', 'id': 13, 'progress': 100, 'resources': [{'id': 4711, 'type': 'primary_ip'}], 'started': '2016-01-30T23:55:00+00:00', 'status': 'success'}}, 'schema': Defs.components_schemas_change_primary_ip_protection_response}}, 'description': 'The `action` key contains the `change_protection` Action'}}, 'tags': ['primary_ips'], 'operationId': 'change_primary_ip_protection', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
| `server_is_load_balancer_target`  | The server ipv4 address is a loadbalancer target              |
 Unassign a Primary IP from a resource"""
        class R:
            _path = ['id'];
            # = {'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'unassign_primary_ip', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': None, 'id': 13, 'progress': 0, 'resources': [{'id': 42, 'type': 'server'}, {'id': 4711, 'type': 'primary_ip'}], 'started': '2016-01-30T23:50:00+00:00', 'status': 'running'}}, 'schema': Defs.components_schemas_unassign_primary_ip_from_resource_response}}, 'description': 'The `action` key in the reply contains an Action object with this structure'}}, 'tags': ['primary_ips'], 'operationId': 'unassign_primary_ip_from_resource'}
            id = {'type': 'integer'}
        R.id = id
...
class server_types:
    ...
    class get:
        ...
        class R:
            _query = ['name', 'page', 'per_page'];
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_list_server_types_response}}, 'description': 'The `server_types` key in the reply contains an array of Server type objects with this structure'}}, 'tags': ['server_types'], 'operationId': 'list_server_types'}
            name = {'type': 'string'}
            page = {'type': 'integer', 'minimum': 1}
            per_page = {'type': 'integer', 'minimum': 1, 'maximum': 50}
        R.name = str_dflt
...
class server_types___id_:
    ...
    class get:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_get_server_type_response}}, 'description': 'The `server_type` key in the reply contains a Server type object with this structure'}}, 'tags': ['server_types'], 'operationId': 'get_server_type'}
            id = {'type': 'integer'}
        R.id = id
...
class servers:
    ...
    class get:
        ...
        class R:
            ...
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_list_servers_response}}, 'description': 'A paged array of servers', 'headers': {'x-next': {'description': 'A link to the next page of responses', 'schema': {'type': 'string'}}}}}, 'tags': ['servers'], 'operationId': 'list_servers'}
            name = {'type': 'string'}
            label_selector = {'type': 'string'}
            sort = {'enum': ['id', 'id:asc', 'id:desc', 'name', 'name:asc', 'name:desc', 'created', 'created:asc', 'created:desc'], 'type': 'string'}
...
class servers___id_:
    ...
    class delete:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_delete_server_response}}, 'description': 'The `action` key in the reply contains an Action object with this structure'}}, 'tags': ['servers'], 'operationId': 'delete_server'}
            id = {'type': 'integer'}
        R.id = id
    ...
    class get:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_get_server_response}}, 'description': 'The `server` key in the reply contains a Server object with this structure'}}, 'tags': ['servers'], 'operationId': 'get_server'}
            id = {'type': 'integer'}
        R.id = id
...
Also note that when updating labels, the Server’s current set of labels will be replaced with the labels provided in the request body. So, for example, if you want to add a new label, you have to provide all existing labels plus the new label in the request body. Update a Server"""
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_replace_server_response}}, 'description': 'The `server` key in the reply contains the updated Server'}}, 'tags': ['servers'], 'operationId': 'replace_server', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
| `server_not_stopped`          | The action requires a stopped server                                 |
 Add a Server to a Placement Group"""
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'add_to_placement_group', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': None, 'id': 13, 'progress': 0, 'resources': [{'id': 42, 'type': 'server'}], 'started': '2016-01-30T23:50:00+00:00', 'status': 'running'}}, 'schema': Defs.components_schemas_add_server_to_placement_group_response}}, 'description': 'The `action` key in the reply contains an Action object with this structure'}}, 'tags': ['servers'], 'operationId': 'add_server_to_placement_group', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
Servers with attached ISOs have a modified boot order: They will try to boot from the ISO first before falling back to hard disk.
 Attach an ISO to a Server"""
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'attach_iso', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': None, 'id': 13, 'progress': 0, 'resources': [{'id': 42, 'type': 'server'}], 'started': '2016-01-30T23:50:00+00:00', 'status': 'running'}}, 'schema': Defs.components_schemas_attach_iso_to_server_response}}, 'description': 'The `action` key in the reply contains an Action object with this structure'}}, 'tags': ['servers'], 'operationId': 'attach_iso_to_server', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
| `networks_overlap`               | The network IP range overlaps with one of the server networks         |
 Attach a Server to a Network"""
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'attach_to_network', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': None, 'id': 13, 'progress': 0, 'resources': [{'id': 42, 'type': 'server'}, {'id': 4711, 'type': 'network'}], 'started': '2016-01-30T23:50:00+00:00', 'status': 'running'}}, 'schema': Defs.components_schemas_attach_server_to_network_response}}, 'description': 'The `action` key in the reply contains an Action object with this structure'}}, 'tags': ['servers'], 'operationId': 'attach_server_to_network', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
class servers___id___actions__change_alias_ips:
    ...
    class post:
        ...
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'change_alias_ips', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': None, 'id': 13, 'progress': 0, 'resources': [{'id': 42, 'type': 'server'}, {'id': 4711, 'type': 'network'}], 'started': '2016-01-30T23:50:00+00:00', 'status': 'running'}}, 'schema': Defs.components_schemas_change_alias_ips_of_network_response}}, 'description': 'The `action` key in the reply contains an Action object with this structure'}}, 'tags': ['servers'], 'operationId': 'change_alias_ips_of_network', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
class servers___id___actions__change_protection:
    ...
    class post:
        ...
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'change_protection', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': '2016-01-30T23:56:00+00:00', 'id': 13, 'progress': 100, 'resources': [{'id': 42, 'type': 'server'}], 'started': '2016-01-30T23:55:00+00:00', 'status': 'success'}}, 'schema': Defs.components_schemas_change_server_protection_response}}, 'description': 'The `action` key in the reply contains an Action object with this structure'}}, 'tags': ['servers'], 'operationId': 'change_server_protection', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
You can either create a `backup` Image that is bound to the Server and therefore will be deleted when the Server is deleted, or you can create an `snapshot` Image which is completely independent of the Server it was created from and will survive Server deletion. Backup Images are only available when the backup option is enabled for the Server. Snapshot Images are billed on a per GB basis.
 Create Image from a Server"""
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'create_image', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': '2016-01-30T23:56:00+00:00', 'id': 13, 'progress': 100, 'resources': [{'id': 42, 'type': 'server'}], 'started': '2016-01-30T23:55:00+00:00', 'status': 'success'}, 'image': {'bound_to': None, 'created': '2016-01-30T23:50:00+00:00', 'created_from': {'id': 1, 'name': 'Server'}, 'deleted': None, 'deprecated': '2018-02-28T00:00:00+00:00', 'description': 'my image', 'disk_size': 10, 'id': 4711, 'image_size': 2.3, 'labels': {'env': 'dev'}, 'name': None, 'os_flavor': 'ubuntu', 'os_version': '20.04', 'protection': {'delete': False}, 'rapid_deploy': False, 'status': 'creating', 'type': 'snapshot'}}, 'schema': Defs.components_schemas_create_image_from_server_response}}, 'description': 'The `image` key in the reply contains an the created Image, which is an object with this structure\n\nThe `action` key in the reply contains an Action object with this structure\n'}}, 'tags': ['servers'], 'operationId': 'create_image_from_server', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
class servers___id___actions__detach_from_network:
    ...
    class post:
        ...
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'detach_from_network', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': None, 'id': 13, 'progress': 0, 'resources': [{'id': 42, 'type': 'server'}, {'id': 4711, 'type': 'network'}], 'started': '2016-01-30T23:50:00+00:00', 'status': 'running'}}, 'schema': Defs.components_schemas_detach_server_from_network_response}}, 'description': 'The `action` key in the reply contains an Action object with this structure'}}, 'tags': ['servers'], 'operationId': 'detach_server_from_network', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
class servers___id___actions__detach_iso:
    ...
    class post:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'detach_iso', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': None, 'id': 13, 'progress': 0, 'resources': [{'id': 42, 'type': 'server'}], 'started': '2016-01-30T23:50:00+00:00', 'status': 'running'}}, 'schema': Defs.components_schemas_detach_iso_from_server_response}}, 'description': 'The `action` key in the reply contains an Action object with this structure'}}, 'tags': ['servers'], 'operationId': 'detach_iso_from_server'}
            id = {'type': 'integer'}
        R.id = id
...
Backups are automatically created daily.
 Enable and Configure Backups for a Server"""
        class R:
            _path = ['id'];
            # = {'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'enable_backup', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': '2016-01-30T23:56:00+00:00', 'id': 13, 'progress': 100, 'resources': [{'id': 42, 'type': 'server'}], 'started': '2016-01-30T23:55:00+00:00', 'status': 'success'}}, 'schema': Defs.components_schemas_enable_and_configure_backups_for_server_response}}, 'description': 'The `action` key in the reply contains an Action object with this structure'}}, 'tags': ['servers'], 'operationId': 'enable_and_configure_backups_for_server'}
            id = {'type': 'integer'}
        R.id = id
...
Enabling rescue mode will not [reboot](https://docs.hetzner.cloud/#server-actions-soft-reboot-a-server) your Server — you will have to do this yourself.
 Enable Rescue Mode for a Server"""
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'enable_rescue', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': '2016-01-30T23:56:00+00:00', 'id': 13, 'progress': 100, 'resources': [{'id': 42, 'type': 'server'}], 'started': '2016-01-30T23:55:00+00:00', 'status': 'success'}, 'root_password': 'zCWbFhnu950dUTko5f40'}, 'schema': Defs.components_schemas_enable_rescue_mode_for_server_response}}, 'description': 'The `root_password` key in the reply contains the root password that can be used to access the booted rescue system.\n\nThe `action` key in the reply contains an Action object with this structure\n'}}, 'tags': ['servers'], 'operationId': 'enable_rescue_mode_for_server', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
class servers___id___actions__poweroff:
    ...
    class post:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'stop_server', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': None, 'id': 13, 'progress': 0, 'resources': [{'id': 42, 'type': 'server'}], 'started': '2016-01-30T23:50:00+00:00', 'status': 'running'}}, 'schema': Defs.components_schemas_power_off_server_response}}, 'description': 'The `action` key in the reply contains an Action object with this structure'}}, 'tags': ['servers'], 'operationId': 'power_off_server'}
            id = {'type': 'integer'}
        R.id = id
...
class servers___id___actions__poweron:
    ...
    class post:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'start_server', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': None, 'id': 13, 'progress': 0, 'resources': [{'id': 42, 'type': 'server'}], 'started': '2016-01-30T23:50:00+00:00', 'status': 'running'}}, 'schema': Defs.components_schemas_power_on_server_response}}, 'description': 'The `action` key in the reply contains an Action object with this structure'}}, 'tags': ['servers'], 'operationId': 'power_on_server'}
            id = {'type': 'integer'}
        R.id = id
...
class servers___id___actions__reboot:
    ...
    class post:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'reboot_server', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': None, 'id': 13, 'progress': 0, 'resources': [{'id': 42, 'type': 'server'}], 'started': '2016-01-30T23:50:00+00:00', 'status': 'running'}}, 'schema': Defs.components_schemas_soft_reboot_server_response}}, 'description': 'The `action` key in the reply contains an Action object with this structure'}}, 'tags': ['servers'], 'operationId': 'soft_reboot_server'}
            id = {'type': 'integer'}
        R.id = id
...
class servers___id___actions__remove_from_placement_group:
 ...
 Remove from Placement Group"""
        class R:
            _path = ['id'];
            # = {'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'remove_from_placement_group', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': '2016-01-30T23:56:00+00:00', 'id': 13, 'progress': 100, 'resources': [{'id': 42, 'type': 'server'}], 'started': '2016-01-30T23:55:00+00:00', 'status': 'success'}}, 'schema': Defs.components_schemas_remove_from_placement_group_response}}, 'description': 'The `action` key in the reply contains an Action object with this structure'}}, 'tags': ['servers'], 'operationId': 'remove_from_placement_group'}
            id = {'type': 'integer'}
        R.id = id
...
class servers___id___actions__request_console:
    ...
    class post:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'request_console', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': '2016-01-30T23:56:00+00:00', 'id': 13, 'progress': 100, 'resources': [{'id': 42, 'type': 'server'}], 'started': '2016-01-30T23:55:00+00:00', 'status': 'success'}, 'password': '9MQaTg2VAGI0FIpc10k3UpRXcHj2wQ6x', 'wss_url': 'wss://console.hetzner.cloud/?server_id=1&token=3db32d15-af2f-459c-8bf8-dee1fd05f49c'}, 'schema': Defs.components_schemas_request_console_for_server_response}}, 'description': 'The `action` key in the reply contains an Action object with this structure'}}, 'tags': ['servers'], 'operationId': 'request_console_for_server'}
            id = {'type': 'integer'}
        R.id = id
...
class servers___id___actions__reset:
    ...
    class post:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'reset_server', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': None, 'id': 13, 'progress': 0, 'resources': [{'id': 42, 'type': 'server'}], 'started': '2016-01-30T23:50:00+00:00', 'status': 'running'}}, 'schema': Defs.components_schemas_reset_server_response}}, 'description': 'The `action` key in the reply contains an Action object with this structure'}}, 'tags': ['servers'], 'operationId': 'reset_server'}
            id = {'type': 'integer'}
        R.id = id
...
If this does not succeed you can use the rescue system to netboot the Server and manually change your Server password by hand.
 Reset root Password of a Server"""
        class R:
            _path = ['id'];
            # = {'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'reset_password', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': None, 'id': 13, 'progress': 0, 'resources': [{'id': 42, 'type': 'server'}], 'started': '2016-01-30T23:50:00+00:00', 'status': 'running'}, 'root_password': 'zCWbFhnu950dUTko5f40'}, 'schema': Defs.components_schemas_reset_root_password_of_server_response}}, 'description': 'The `root_password` key in the reply contains the new root password that will be active if the Action succeeds.\n\nThe `action` key in the reply contains an Action object with this structure:\n'}}, 'tags': ['servers'], 'operationId': 'reset_root_password_of_server'}
            id = {'type': 'integer'}
        R.id = id
...
We limit the number of samples returned to a maximum of 500 and will adjust the step parameter accordingly.
 Get Metrics for a Server"""
        class R:
            _query = ['type', 'start', 'end', 'step']; _path = ['id'];
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_get_metrics_for_server_response}}, 'description': 'The `metrics` key in the reply contains a metrics object with this structure'}}, 'tags': ['servers'], 'operationId': 'get_metrics_for_server'}
            id = {'type': 'integer'}
...
class ssh_keys:
    ...
    class get:
        ...
        class R:
            ...
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_list_ssh_keys_response}}, 'description': 'The `ssh_keys` key in the reply contains an array of SSH key objects with this structure'}}, 'tags': ['ssh_keys'], 'operationId': 'list_ssh_keys'}
    ...
    class post:
        ...
        class R:
            _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'schema': Defs.components_schemas_create_ssh_key_response}}, 'description': 'The `ssh_key` key in the reply contains the object that was just created'}}, 'tags': ['ssh_keys'], 'operationId': 'create_ssh_key', 'mime': 'application/json'}
...
class ssh_keys___id_:
    ...
    class delete:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'204': {'description': 'SSH key deleted'}}, 'tags': ['ssh_keys'], 'operationId': 'delete_ssh_key'}
            id = {'type': 'string'}
        R.id = id
    ...
    class get:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_get_ssh_key_response}}, 'description': 'The `ssh_key` key in the reply contains an SSH key object with this structure'}}, 'tags': ['ssh_keys'], 'operationId': 'get_ssh_key'}
            id = {'type': 'integer'}
        R.id = id
...
class volumes:
    ...
    class get:
        ...
        class R:
            ...
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_list_volumes_response}}, 'description': 'The `volumes` key contains a list of volumes'}}, 'tags': ['volumes'], 'operationId': 'list_volumes'}
            status = {'enum': ['available', 'creating'], 'type': 'string'}
            sort = {'enum': ['id', 'id:asc', 'id:desc', 'name', 'name:asc', 'name:desc', 'created', 'created:asc', 'created:desc'], 'type': 'string'}
            name = {'type': 'string'}
            label_selector = {'type': 'string'}
...
| `no_space_left_in_location`         | There is no volume space left in the given location |
 Create a Volume"""
        class R:
            _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'create_volume', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': None, 'id': 13, 'progress': 0, 'resources': [{'id': 42, 'type': 'server'}, {'id': 554, 'type': 'volume'}], 'started': '2016-01-30T23:50:00+00:00', 'status': 'running'}, 'next_actions': [{'command': 'attach_volume', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': None, 'id': 13, 'progress': 0, 'resources': [{'id': 42, 'type': 'server'}, {'id': 554, 'type': 'volume'}], 'started': '2016-01-30T23:50:00+00:00', 'status': 'running'}], 'volume': {'created': '2016-01-30T23:50:11+00:00', 'format': 'xfs', 'id': 4711, 'labels': {'env': 'dev'}, 'linux_device': '/dev/disk/by-id/scsi-0HC_Volume_4711', 'location': {'city': 'Falkenstein', 'country': 'DE', 'description': 'Falkenstein DC Park 1', 'id': 1, 'latitude': 50.47612, 'longitude': 12.370071, 'name': 'fsn1', 'network_zone': 'eu-central'}, 'name': 'database-storage', 'protection': {'delete': False}, 'server': 12, 'size': 42, 'status': 'available'}}, 'schema': Defs.components_schemas_create_volume_response}}, 'description': 'The `volume` key contains the Volume that was just created\n\nThe `action` key contains the Action tracking Volume creation\n'}}, 'tags': ['volumes'], 'operationId': 'create_volume', 'mime': 'application/json'}
...
class volumes___id_:
    ...
    class delete:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'204': {'description': 'Volume deleted'}}, 'tags': ['volumes'], 'operationId': 'delete_volume'}
            id = {'type': 'string'}
        R.id = id
    ...
    class get:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'200': {'content': {'application/json': {'schema': Defs.components_schemas_get_volume_response}}, 'description': 'The `volume` key contains the volume'}}, 'tags': ['volumes'], 'operationId': 'get_volume'}
            id = {'type': 'integer'}
        R.id = id
...
class volumes___id___actions__attach:
    ...
    class post:
        ...
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'attach_volume', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': None, 'id': 13, 'progress': 0, 'resources': [{'id': 43, 'type': 'server'}, {'id': 554, 'type': 'volume'}], 'started': '2016-01-30T23:50:00+00:00', 'status': 'running'}}, 'schema': Defs.components_schemas_attach_volume_to_server_response}}, 'description': 'The `action` key contains the `attach_volume` Action'}}, 'tags': ['volumes'], 'operationId': 'attach_volume_to_server', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
class volumes___id___actions__change_protection:
    ...
    class post:
        ...
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'change_protection', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': '2016-01-30T23:56:00+00:00', 'id': 13, 'progress': 100, 'resources': [{'id': 42, 'type': 'server'}, {'id': 554, 'type': 'volume'}], 'started': '2016-01-30T23:55:00+00:00', 'status': 'success'}}, 'schema': Defs.components_schemas_change_volume_protection_response}}, 'description': 'The `action` key contains the `change_protection` Action'}}, 'tags': ['volumes'], 'operationId': 'change_volume_protection', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
class volumes___id___actions__detach:
    ...
    class post:
        ...
        class R:
            _path = ['id'];
            # = {'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'detach_volume', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': None, 'id': 13, 'progress': 0, 'resources': [{'id': 42, 'type': 'server'}], 'started': '2016-01-30T23:50:00+00:00', 'status': 'running'}}, 'schema': Defs.components_schemas_detach_volume_response}}, 'description': 'The `action` key contains the `detach_volume` Action'}}, 'tags': ['volumes'], 'operationId': 'detach_volume'}
            id = {'type': 'integer'}
        R.id = id
...
class volumes___id___actions__resize:
    ...
    class post:
        ...
        class R:
            _path = ['id']; _body = ['body'];
            # = {'requestBody': {'content': {}}, 'responses': {'201': {'content': {'application/json': {'example': {'action': {'command': 'resize_volume', 'error': {'code': 'action_failed', 'message': 'Action failed'}, 'finished': None, 'id': 13, 'progress': 0, 'resources': [{'id': 554, 'type': 'volume'}], 'started': '2016-01-30T23:50:00+00:00', 'status': 'running'}}, 'schema': Defs.components_schemas_resize_volume_response}}, 'description': 'The `action` key contains the `resize_volume` Action'}}, 'tags': ['volumes'], 'operationId': 'resize_volume', 'mime': 'application/json'}
            id = {'type': 'integer'}
...
keyw = {'from', 'raise', 'continue', 'if', 'for', 'not', 'async', 'import', 'except', 'while'}
